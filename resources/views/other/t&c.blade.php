    ...
    <main class="col-md-12">
        <div class="container">
            ...
            <section>
                ...
                <div>
                    <h2>1. Parties</h2>
                    <p>1.1 This Agreement is made between You the customer ("Customer") and Energy Services Online Limited ("Energy Services Online"), a company registered in England, (Company Number 03798799) whose registered address is 14 Marchwood Crescent, London W5 2DZ.</p>
                    <br />
                </div>
                <div>
                    <h2>2. Definitions</h2>
                    <p>2.1 In this Agreement, unless the context otherwise requires: "We", "Us", "Our" and related expressions refer to Energy Services Online Limited.
                    <br />
                    <br />
                    2.2 "You", "Your", "Customer" and related expressions refer to the user of the Service and/or Our Site. 2.3 "Our Site" means the website with address www.TheEnergyShop.com. 
                    <br />
                    <br />
                    2.4 "Service" means the service provided by Energy Services Online via the TheEnergyShop.com website ("Our Site") or call centre whereby the Customer may obtain impartial information on the Suppliers and the services and products they offer and potentially transact with the Suppliers for the provision of those services and/or products;
                    <br />
                    <br />
                ...
                <div>
                    ...
                    <br />
                    <br />
                    4.2 You will be responsible for making all payments due to Suppliers on the terms agreed with the relevant Supplier and Energy Services Online shall have no responsibility for transmission of payments to any Supplier.</p>
                    <br />
                </div>
                <div>
                    <h2>5. Buyer's Obligations</h2>
                ...
                <div>
                    ...
                    <p>6.1 All web site design, text, graphics, the selection and arrangement thereof, and all software compilations, underlying source code, software (including applets) and all other materials on Our Site are copyright Energy Services Online Limited and its affiliates, or its content and technology providers. 
                    <br />
                    <br />
                ...
                <div>
                    <h2>7. Indemnity</h2>
                    <p>7.1 You shall indemnify Energy Services Online against each loss, liability or cost incurred by Energy Services Online arising out of: any claims or legal proceedings arising from Your use of the Services which are brought or threatened against Energy Services Online by any other person; or any breach of this Agreement by You.</p>
                    <br />
                </div>
                <div>
                    ...
                    <br />
                    <br />
                    8.5 Except as otherwise provided herein, Energy Services Online shall not have any liability other than in respect of: death or personal injury arising from its own negligence or that of its employees, agents or contractors while acting in the course of their employment by Energy Services Online; or any liability of Energy Services Online which cannot by Law be excluded or restricted. 
                    <br />
                    <br />
                    8.6 Subject to the liability which we accept in clause 8.4: (a) our aggregate liability to you arising out of or in connection with this Agreement or use of the Service shall not exceed ï¿½50; and (b) We shall not be liable in contract, tort or otherwise howsoever arising out of or in connection with this agreement or use of the Service for any indirect loss, consequential loss, loss of profits, data, revenue, business opportunity, anticipated savings, goodwill or reputation.</p>
                    <br />
                </div>
                <div>
                    <h2>9. Exclusion of liability for third party providers' products and services</h2>
                ...
                <div>
                    <h2>11. Assignment</h2>
                    <p>11.1 You shall not assign or delegate or otherwise deal with all or any of Your rights or obligations under this Agreement. Energy Services Online shall have the right to assign or otherwise delegate all or any of its rights or obligations under this Agreement to any person or entity.</p>
                    <br />
                </div>
                <div>
                    <h2>12. Force Majeure</h2>
                    <p>12.1 Energy Services Online shall not be liable for any breach of its obligations under this Agreement where it is hindered or prevented from carrying out its obligations by any cause outside its reasonable control, including without limitation by lightning, fire, flood, extremely severe weather, strike, lock-out, labour dispute, act of God, war, riot, civil commotion, malicious damage, failure of any telecommunications or computer system, compliance with any law, accident (or by any damage caused by any of such events).</p>
                    <br />
                </div>
                <div>
                ...
                <div>
                    <h2>14. Notices</h2>
                    <p>14.1 Unless otherwise stated within this Agreement, notices to be given to either party shall be in writing and shall be delivered by hand, electronic mail (other than for the purpose of legal process) sent by fax or pre-paid post to the Customer at the address supplied to Energy Services Online or to Energy Services Online at its address as specified on the Our Site.</p>
                    <br />
                </div>
                <div>
