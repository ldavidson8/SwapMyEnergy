...
a.default-link:hover, a.default-link:active
{
    color: #fdae36;
    outline: none;
}
        ...
        <div class="container">
            ...
            <section>
                ...
                <h2 class="section-title">1. Parties</h2>
                    <p class="paragraph-normal">1.1 This Agreement is made between You the customer ("Customer") and <!--change here-->Znergi Ltd. ("Swap My Energy"), a company registered in England, (Company Number <!--change here-->01772 000000) whose registered address is <!--change here-->Estate House, 18 Fox St, Preston PR1 2AB.</p>
                    <br />
                <h2 class="section-title">2. Definitions</h2>
                    <p class="paragraph-normal">2.1 In this Agreement, unless the context otherwise requires: "We", "Us", "Our" and related expressions refer to <!--change here-->Znergi Ltd.
                    <br />
                    <br />
                    2.2 "You", "Your", "Customer" and related expressions refer to the user of the Service and/or Our Site.
                    <br />
                    <br />
                    2.3 "Our Site" means the website with address <!--change here--><a class="default-link" href="#">www.swapmyenergy.co.uk.</a> 
                    <br />
                    <br />
                ...
                <h2 class="section-title">3. Use of the Service</h2>
                    <p class="paragraph-normal">3.1 Use of this Service is subject to the terms and conditions set out in this Agreement. 
                    <br />
                    <br />
                ...
                <h2 class="section-title">4. Payment</h2>
                    <p class="paragraph-normal">4.1 Use of the Service is currently free. However, we reserve the right to make charges for certain services or to make charges for the use of Services that were previously free. If at any time we impose a charge for our service, We will notify You of any applicable charges before any such services can be accessed or before any charges are levied. 
                    <br />
                    <br />
                ...
                <h2 class="section-title">5. Buyer's Obligations</h2>
                    <p class="paragraph-normal">5.1 If You choose to purchase a product and/or service, We will inform You of any applicable terms and conditions imposed by the Supplier, in relation to the supply of its goods, products and/or services and You agree to abide by those terms and conditions. 
                    <br />
                    <br />
                ...
                <h2 class="section-title">6. Intellectual Property Rights</h2>
                    <p class="paragraph-normal">6.1 All web site design, text, graphics, the selection and arrangement thereof, and all software compilations, underlying source code, software (including applets) and all other materials on Our Site are copyright <!--change here-->Znergi Ltd. and its affiliates, or its content and technology providers. 
                    <br />
                    <br />
                ...
                <h2 class="section-title">9. Exclusion of liability for third party providers' products and services</h2>
                    <p class="paragraph-normal">9.1 Your attention is drawn to the fact that when purchasing goods or services from a third party Supplier through Our Site or through Our Service, You may be subject to further terms and conditions in respect of such goods or services purchased, which may be imposed by such third party Supplier. Your acceptance of such terms and conditions is at Your own risk. You should check that You agree to those terms and conditions before making an application or entering into any transaction.</p>
                    <br />
                <h2 class="section-title">10. Data Protection and Privacy</h2>
                    <p class="paragraph-normal">10.1 We are committed to protecting your privacy. Our privacy practices are set out in our Privacy Policy displayed on Our Site. You agree that You have read Our Privacy Policy and that You agree that the terms of such policy are reasonable. 
                    <br />
                    <br />
                ...
                <h2 class="section-title">11. Assignment</h2>
                    <p class="paragraph-normal">11.1 You shall not assign or delegate or otherwise deal with all or any of Your rights or obligations under this Agreement. <!--change here-->Swap My Energy shall have the right to assign or otherwise delegate all or any of its rights or obligations under this Agreement to any person or entity.</p>
                    <br />
                <h2 class="section-title">12. Force Majeure</h2>
                    <p class="paragraph-normal">12.1 <!--change here-->Swap My Energy shall not be liable for any breach of its obligations under this Agreement where it is hindered or prevented from carrying out its obligations by any cause outside its reasonable control, including without limitation by lightning, fire, flood, extremely severe weather, strike, lock-out, labour dispute, act of God, war, riot, civil commotion, malicious damage, failure of any telecommunications or computer system, compliance with any law, accident (or by any damage caused by any of such events).</p>
                    <br />
                <h2 class="section-title">13. Entire Agreement</h2>
                    <p class="paragraph-normal">This Agreement, together with any terms and conditions incorporated herein or referred to in it, represents the entire understanding between the parties in relation to the subject matter herein and supersedes all other agreements or representations by either party, whether oral or written, and may not be amended or modified except in writing or by making such amendments or modifications available on Our Site.</p>
                    <br />
                <h2 class="section-title">14. Notices</h2>
                    <p class="paragraph-normal">14.1 Unless otherwise stated within this Agreement, notices to be given to either party shall be in writing and shall be delivered by hand, electronic mail (other than for the purpose of legal process) sent by fax or pre-paid post to the Customer at the address supplied to <!--change here-->Swap My Energy or to Znergi Ltd. at its address as specified on the Our Site.</p>
                    <br />
                <h2 class="section-title">15. Termination</h2>
                    <p class="paragraph-normal">15.1 We may terminate or suspend your access to the Service at any time. 
                    <br />
                    <br />
                ...
                <h2 class="section-title">16. General</h2>
                    <p class="paragraph-normal">16.1 This Service, and the content of our Site is directed solely at Customers who access the site from the United Kingdom, and in the specific case of domestic energy products or services, Customers who reside in Great Britain. We make no representation that any product or service referred to on Our Site is available or otherwise suitable for use outside of the United Kingdom (or in the case of energy products and services, outside of Great Britain). 
                    <br />
                    <br />
                ...
                <h2 class="section-title">17. Governing Law</h2>
                    <p class="paragraph-normal">17.1 This Agreement shall be governed by and construed in accordance with the laws of England and Wales and both parties hereby submit to the non-exclusive jurisdiction of the courts of England and Wales.</p>
                    <br />
                <br />
                <br />
            </section>
