            ...
            <section>
                ...
                <h2 class="section-title">When do we use Cookies?</h2>
                    <p class="section-content">
                        ...
                        <br />
                        <br />
                        They include cookies that allow you to move from one page of the site to another and to access and use certain services within the site. They also enable us to remember your search criteria as you move between pages and to pass this information to the suppliers that you redirect to from swapmyenergy.co.uk.
                        <br />
                        <br />
                        They also include cookies to record whether or not you go on to complete a transaction or application with an energy supplier that you redirect to from swapmyenergy.co.uk which is required in order to allow us to ensure that the links between with our partners are working correctly and to identify and rectify any problems or errors that may occur.
                        <br />
                        <br />
                        <span class="font-weight-bold">For optimisation and personalisation</span>
                        <br />
                        We want you to have a good experience when you are using our website and our services. These Cookies are used to optimise and personalise your experience of the swapmyenergy.co.uk. For example, we use Cookies to recognise whether you are a first-time visitor or a return visitor and to tailor the presentation of the swapmyenergy.co.uk Services. These types of Cookies are also used to recognise you when you access swapmyenergy.co.uk from different devices, to provide you with a consistent experience.
                        <br />
                        <br />
