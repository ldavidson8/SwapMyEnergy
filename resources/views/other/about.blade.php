...
@section('main-content')
    ...
    <div class="d-flex">
        <div class="d-flex container-fluid no-padding background-image-preston-behind full-size-30">
            <div class="row flex-grow-1 background-image-preston background-image-bottom preload center-content">
