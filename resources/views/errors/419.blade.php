        ...
        <div class="flex-grow-1 row flex-grow-1 no-padding">
            ...
            <div class="col-xl-5 col-lg-6 col-md-8 col-12" style="background: #f0f0f0; background-position: left;">
                <table class="table-center-contents">
                    <tr>
                        <td>
                            <h1 style="font-weight: bold; font-size: 40px; color: #000; text-align: center; letter-spacing: -3px;"><span style="letter-spacing: 3px; font-size: 100px; color: #00C2CB;">419</span><br />Your Session Has Expired</h1>
                            <br />
                            <div style="color: #000; text-align: center; font-size: 18px; letter-spacing: 1px;">
                                <p>Your session has <span style=" color: #00C2CB;">expired</span><br />Please go back and try again<p>
                                <br /><br />
