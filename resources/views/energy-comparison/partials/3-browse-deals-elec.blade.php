...
<div id="sticky-existing-tariff" class="container rounded-container blue-rounded-container" style="z-index: 10;">
    <div class="row no-padding">
        ...
        <div class="col-lg-2 col-12 existing-supplier-logo no-padding">
            <table class="form-table"><tr><td><img src="{{ asset('img/supplier-logos/' . $current_tariffs -> E -> supplierName . '.png') }}" alt="{{ $current_tariffs -> E -> supplierName }}" style="border-radius: 0 0 20px 0; max-width: 100%; max-height: 100%;" width="auto" height="auto"></td></tr></table>
        </div>
    </div>
    <div id="sticky-toggle-tab-close" class="sticky-toggle-tab"><span class="fas fa-angle-up"></span></div>
</div>
<div id="sticky-none" style="z-index: 9;">
