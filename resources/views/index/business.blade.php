...
@section('main-content')
    ...
    <hr />
    <div class="d-flex">
        <div class="full-size-40 container-fluid flex-column padding-20px d-flex center-content">
    ...
    <div class="d-flex">
        <div class="full-size-50 container-fluid d-flex flex-column background-image-preston-behind">
            <div class="row flex-grow-1 padding-bottom-20px background-image-preston background-image-bottom preload d-flex center-content">
